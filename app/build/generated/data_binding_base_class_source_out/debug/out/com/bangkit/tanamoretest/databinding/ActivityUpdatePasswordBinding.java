...
public final class ActivityUpdatePasswordBinding implements ViewBinding {
  ...
  private ActivityUpdatePasswordBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnAuth,
      @NonNull Button btnUpdate, @NonNull EditText etNewPass, @NonNull EditText etNewPassConfirm,
      @NonNull EditText etPassword, @NonNull LinearLayout layoutUpdatePassword,
      @NonNull LinearLayout layoutVerificationPassword, @NonNull ConstraintLayout main) {
    this.rootView = rootView;
    this.btnAuth = btnAuth;
    this.btnUpdate = btnUpdate;
    this.etNewPass = etNewPass;
    this.etNewPassConfirm = etNewPassConfirm;
  ...
  public static ActivityUpdatePasswordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.etNewPassConfirm;
      EditText etNewPassConfirm = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityUpdatePasswordBinding((ConstraintLayout) rootView, btnAuth, btnUpdate,
          etNewPass, etNewPassConfirm, etPassword, layoutUpdatePassword, layoutVerificationPassword,
          main);
    }
